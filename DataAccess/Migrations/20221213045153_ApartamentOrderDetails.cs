...
{
    public partial class ApartamentOrderDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ApartamentOrderDetails",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartamentOrderDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartamentOrderDetails_HomeAps_ApartamentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartamentOrderDetails_ApartamentId",
                table: "ApartamentOrderDetails",
                column: "ApartamentId");
        }
